...
function MonoTag({ label }: { label: string }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 28 }}>
      ...
      <span style={{ ...MONO, fontSize: 15, letterSpacing: '0.26em', textTransform: 'uppercase', color: C.green }}>
        {label}
      </span>
    </div>
  );
...
function MetricBox({ value, label }: { value: string; label: string }) {
  return (
    <div style={{
      ...
      <div style={{ ...SERIF, fontSize: 'clamp(30px, 3.5vw, 38px)', color: C.green, lineHeight: 1, marginBottom: 8 }}>
        {value}
      </div>
      <div style={{ ...MONO, fontSize: 15, color: C.muted, letterSpacing: '0.1em', textTransform: 'uppercase' }}>
        {label}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ marginBottom: 24 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 10 }}>
        <span style={{ ...SANS, fontSize: 17, color: C.muted, fontWeight: 400 }}>{label}</span>
        <span style={{ ...MONO, fontSize: 18, color: C.cream, fontWeight: 600 }}>{format(value)}</span>
      </div>
...
function OutputMetric({ label, value, sub }: { label: string; value: string; sub?: string }) {
  return (
    <div style={{
      ...
      <div style={{ ...MONO, fontSize: 14, color: C.green, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 12 }}>
        {label}
      </div>
      <div style={{ ...SERIF, fontSize: 'clamp(28px, 3vw, 42px)', color: C.cream, lineHeight: 1 }}>
        {value}
      </div>
      {sub && (
        <div style={{ ...SANS, fontSize: 16, color: C.muted, marginTop: 8, fontWeight: 300 }}>{sub}</div>
      )}
    </div>
  );
}
    ...
    <>
      ...
      <div style={{ background: C.dark, minHeight: '100vh', paddingTop: 80 }}>
        ...
        <div data-section style={{
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(22px, 5vw, 48px)' }}>
            <FadeIn>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                  {[
                    ...
                    <div key={i} style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
                      ...
                      <p style={{ ...SANS, fontSize: 19, color: C.muted, fontWeight: 300, lineHeight: 1.7, margin: 0 }}>
                        {text}
                      </p>
                    </div>
                  ))}
              ...
              <FadeIn delay={0.15}>
                ...
                <div style={{
                  ...
                  <p style={{ ...MONO, fontSize: 15, color: C.steel, letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 12 }}>
                    Why it compounds
                  </p>
                  <p style={{ ...SANS, fontSize: 18, color: C.muted, fontWeight: 300, lineHeight: 1.7, margin: 0 }}>
        ...
        <div data-section style={{ background: C.dark, padding: 'clamp(64px, 8vw, 112px) 0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(22px, 5vw, 48px)' }}>
            <FadeIn>
              ...
              <p style={{ ...SANS, fontSize: 19, color: C.muted, fontWeight: 300, maxWidth: 540, lineHeight: 1.6, marginBottom: 48 }}>
            ...
            <div style={{
              ...
              <FadeIn delay={0.05}>
                <div style={{
                  ...
                  <p style={{ ...MONO, fontSize: 15, color: C.green, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 28 }}>
                    Input parameters
                  </p>
                  ...
                  <div style={{
                    ...
                    {[
                      ...
                      <div key={item.k} style={{
                        ...
                        <div style={{ ...MONO, fontSize: 11, color: C.steel, letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 6 }}>
                          {item.k}
                        </div>
                        <div style={{ ...MONO, fontSize: 18, color: C.cream, fontWeight: 600 }}>
                          {item.v}
                        </div>
                      </div>
                    ))}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 16 }}>
                      <span style={{ ...MONO, fontSize: 15, color: C.green, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
                        10-year projection
                      </span>
                      <span style={{ ...MONO, fontSize: 17, color: tenYearProfit >= 0 ? C.green : '#F87171' }}>
                    ...
                    <div style={{ display: 'flex', height: 32, borderRadius: 8, overflow: 'hidden', gap: 2 }}>
                      ...
                      >
                        {capexPct > 12 && (
                          <span style={{ ...MONO, fontSize: 14, color: C.steel, whiteSpace: 'nowrap' }}>CAPEX</span>
                        )}
                      </motion.div>
                      <motion.div
                      ...
                      >
                        {profitPct > 20 && (
                          <span style={{ ...MONO, fontSize: 14, color: C.dark, whiteSpace: 'nowrap' }}>10-yr profit</span>
                        )}
                      </motion.div>
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: 24, marginTop: 14 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <span style={{ ...MONO, fontSize: 15, color: C.steel }}>CAPEX — {fmtCurrency(capex)}</span>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        <div style={{ width: 10, height: 10, borderRadius: 2, background: C.green }} />
                        <span style={{ ...MONO, fontSize: 15, color: C.steel }}>10-yr gross — {fmtCurrency(tenYrGross)}</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div data-section style={{ background: C.alt, padding: 'clamp(64px, 8vw, 112px) 0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(22px, 5vw, 48px)' }}>
            <FadeIn>
              ...
              <p style={{ ...SANS, fontSize: 19, color: C.muted, fontWeight: 300, maxWidth: 520, lineHeight: 1.6, marginBottom: 44 }}>
            ...
            <FadeIn delay={0.08}>
              ...
              >
                ...
                <div style={{
                  ...
                  <h3 style={{ ...SERIF, fontSize: 'clamp(24px, 2.5vw, 32px)', color: C.cream, marginBottom: 16, lineHeight: 1.2 }}>
                    {activeStream.headline}
                  </h3>
                  <p style={{ ...SANS, fontSize: 19, color: C.muted, fontWeight: 300, lineHeight: 1.75, margin: 0 }}>
                    {activeStream.body}
                  </p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ ...MONO, fontSize: 14, color: activeStream.accent, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 24 }}>
                    Key metrics
                  </p>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                    {activeStream.metrics.map((m, i) => (
                      <div key={m.k} style={{
                        ...
                        <span style={{ ...MONO, fontSize: 16, color: C.steel }}>{m.k}</span>
                        <span style={{ ...SANS, fontSize: 19, color: C.cream, fontWeight: 500 }}>{m.v}</span>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {[
                ...
                <FadeIn key={i} delay={i * 0.1}>
                  <div style={{
                    ...
                    <div style={{ ...SANS, fontSize: 21, color: C.cream, fontWeight: 500, marginBottom: 8, lineHeight: 1.3 }}>
                      {item.label}
                    </div>
                    <div style={{ ...MONO, fontSize: 15, color: C.steel, letterSpacing: '0.1em' }}>
                      {item.sub}
                    </div>
                  </div>
                </FadeIn>
        ...
        <div data-section style={{ background: C.alt, padding: 'clamp(64px, 8vw, 112px) 0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(22px, 5vw, 48px)' }}>
            <FadeIn>
              ...
              <p style={{ ...SANS, fontSize: 19, color: C.muted, fontWeight: 300, maxWidth: 520, lineHeight: 1.6, marginBottom: 48 }}>
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(22px, 5vw, 48px)' }}>
            <FadeIn>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 56 }}>
                ...
                <span style={{ ...MONO, fontSize: 14, color: C.steel, letterSpacing: '0.25em', textTransform: 'uppercase' }}>
                  next steps
                </span>
              ...
              <div style={{
                ...
                <Link to="/traction" style={{ textDecoration: 'none' }}>
                  ...
                  >
                    <div style={{ ...MONO, fontSize: 15, color: C.green, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 16 }}>
                      01
                    </div>
                    <h3 style={{ ...SERIF, fontSize: 'clamp(24px, 2.5vw, 32px)', color: C.cream, marginBottom: 12, lineHeight: 1.2 }}>
                      Explore the traction
                    </h3>
                    <p style={{ ...SANS, fontSize: 18, color: C.muted, fontWeight: 300, lineHeight: 1.65, marginBottom: 28 }}>
                      Nvidia Inception, Barclays Eagle Labs, and our proof points — see where we are today.
                    </p>
                    <span style={{ ...MONO, fontSize: 16, color: C.green, letterSpacing: '0.1em' }}>
                      View traction →
                    </span>
                  </div>
                </Link>
                ...
                <Link to="/calculator" style={{ textDecoration: 'none' }}>
                  ...
                  >
                    <div style={{ ...MONO, fontSize: 15, color: C.dark, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 16, opacity: 0.6 }}>
                      02
                    </div>
                    <h3 style={{ ...SERIF, fontSize: 'clamp(24px, 2.5vw, 32px)', color: C.dark, marginBottom: 12, lineHeight: 1.2 }}>
                      Model your site
                    </h3>
                    <p style={{ ...SANS, fontSize: 18, color: C.dark, fontWeight: 400, lineHeight: 1.65, marginBottom: 28, opacity: 0.75 }}>
                      Run a full projection for your renewable site — panels, location, offtake price, and more.
                    </p>
                    <span style={{ ...MONO, fontSize: 16, color: C.dark, letterSpacing: '0.1em' }}>
                      Open calculator →
                    </span>
                  </div>
                </Link>
