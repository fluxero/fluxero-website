...
function MetricBox({ value, label }: { value: string; label: string }) {
  return (
    <div style={{
      ...
      <div style={{ ...SERIF, fontSize: 'clamp(28px, 3.5vw, 36px)', color: C.green, lineHeight: 1, marginBottom: 8 }}>
        {value}
      </div>
...
function OutputMetric({ label, value, sub }: { label: string; value: string; sub?: string }) {
  return (
    <div style={{
      ...
      <div style={{ ...SERIF, fontSize: 'clamp(26px, 3vw, 42px)', color: C.cream, lineHeight: 1 }}>
        {value}
      </div>
      {sub && (
                  ...
                  <div style={{
                    ...
                    {[
                      ...
                      <div key={item.k} style={{
                        ...
                        <div style={{ ...MONO, fontSize: 10, color: C.steel, letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 6 }}>
                          {item.k}
                        </div>
