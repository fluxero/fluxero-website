  ...
  return (
    <>
      ...
      <div style={{ background: C.dark, minHeight: '100vh', paddingTop: 80 }}>
        ...
        {/* ══════════════════════════════════════════════════════════════════
            SECTION 2 — THESIS (two-column)
        ══════════════════════════════════════════════════════════════════ */}
        <section style={{ background: C.alt, padding: 'clamp(64px, 8vw, 112px) 0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(20px, 5vw, 48px)' }}>
        ...
        ══════════════════════════════════════════════════════════════════ */}
        <section style={{ background: C.dark, padding: 'clamp(64px, 8vw, 112px) 0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(20px, 5vw, 48px)' }}>
            <FadeIn>
        ...
        {/* ══════════════════════════════════════════════════════════════════
            SECTION 7 — CTA
        ══════════════════════════════════════════════════════════════════ */}
        <section style={{ background: C.dark, padding: 'clamp(80px, 10vw, 128px) 0' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 clamp(20px, 5vw, 48px)' }}>
            <FadeIn>
              {/* Divider */}
