    ...
    <div style={{ background: DARK, minHeight: '100vh', color: CREAM }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative' }}>
          <motion.div {...fade}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: MONO, fontSize: 17, letterSpacing: '0.25em', textTransform: 'uppercase', color: G }}>
                Our Solution
              </span>
            </div>
            ...
            <p style={{
              fontFamily: SANS,
              fontSize: 'clamp(22px, 1.6vw, 23px)',
              fontWeight: 300,
              color: MUTED,
              maxWidth: 520,
              lineHeight: 1.7,
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 18 }}>
          {statCards.map((c, i) => (
            ...
            >
              ...
              <p style={{ fontFamily: SANS, fontSize: 20, color: MUTED, lineHeight: 1.65, fontWeight: 300 }}>
                {c.desc}
              </p>
            </motion.div>
          ))}
      ...
      <div data-section style={{ background: DARK, padding: '3rem 2rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <motion.div {...fade} style={{ marginBottom: 48 }}>
            ...
            <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(32px, 4vw, 52px)', color: CREAM, lineHeight: 1.1, marginBottom: 12 }}>
              From wasted electrons<br />to sellable hydrogen.
            </h2>
            <p style={{ fontFamily: SANS, fontSize: 21, color: MUTED, fontWeight: 300, maxWidth: 500, lineHeight: 1.7 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16 }}>
            {[
              ...
              >
                <div style={{ fontFamily: MONO, fontSize: 16, color: s.color, letterSpacing: '0.2em', marginBottom: 8 }}>
                  STAGE {s.id}
                </div>
                <div style={{ fontFamily: SANS, fontSize: 20, color: CREAM, fontWeight: 600, marginBottom: 8 }}>
                  {s.label}
                </div>
                <p style={{ fontFamily: SANS, fontSize: 19, color: MUTED, lineHeight: 1.65, fontWeight: 300 }}>
                  {s.desc}
                </p>
              </motion.div>
            ))}
      ...
      <div data-section style={{ background: ALT, padding: '3rem 2rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <motion.div {...fade} style={{ marginBottom: 44 }}>
            <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(32px, 4vw, 52px)', color: CREAM, lineHeight: 1.1 }}>
              Built for the chaos<br />of curtailment.
            </h2>
            <p style={{ fontFamily: SANS, fontSize: 21, color: MUTED, fontWeight: 300, maxWidth: 480, marginTop: 14, lineHeight: 1.7 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 20 }}>
            {curtailmentPoints.map((p, i) => (
              ...
              >
                <h3 style={{ fontFamily: SERIF, fontSize: 24, color: CREAM, marginBottom: 10 }}>
                  {p.title}
                </h3>
                <p style={{ fontFamily: SANS, fontSize: 20, color: MUTED, lineHeight: 1.7, fontWeight: 300 }}>
                  {p.desc}
                </p>
              </motion.div>
            ))}
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 18 }}>
            {techCards.map((f, i) => (
              ...
              >
                <div style={{ fontFamily: MONO, fontSize: 16, color: STEEL, marginBottom: 18, letterSpacing: '0.18em' }}>
                  {f.num}
                </div>
                <div style={{ width: 28, height: 2, background: f.color, borderRadius: 2, marginBottom: 20 }} />
                <h4 style={{ fontFamily: SERIF, fontSize: 25, color: CREAM, marginBottom: 12, lineHeight: 1.2 }}>
                  {f.title}
                </h4>
                <p style={{ fontFamily: SANS, fontSize: 20, color: MUTED, lineHeight: 1.7, fontWeight: 300 }}>
                  {f.body}
      ...
      <div data-section style={{ background: ALT, padding: '3rem 2rem' }}>
        <div ref={tableRef} style={{ maxWidth: 1100, margin: '0 auto' }}>
          <motion.div {...fade} style={{ marginBottom: 40 }}>
            <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(30px, 3.5vw, 44px)', color: CREAM, lineHeight: 1.15 }}>
                ...
                <thead>
                  <tr style={{ background: 'rgba(0,214,143,0.04)' }}>
                    ...
                    <th style={{ ...thStyle, color: G }}>
                      <span style={{ background: `${G}18`, border: `1px solid ${G}40`, borderRadius: 6, padding: '3px 10px', fontFamily: MONO, fontSize: 16, letterSpacing: '0.1em' }}>
                        SMHP — Fluxero
                      </span>
                    </th>
      ...
      <div data-section style={{ background: DARK, padding: '5rem 2rem 6rem' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          >
            <div>
              <div style={{ fontFamily: MONO, fontSize: 16, color: G, letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: 12 }}>
                Next steps
              </div>
              <h2 style={{ fontFamily: SERIF, fontSize: 'clamp(28px, 3vw, 42px)', color: CREAM, lineHeight: 1.15 }}>
                Ready to see the numbers?
              </h2>
              <p style={{ fontFamily: SANS, fontSize: 20, color: MUTED, fontWeight: 300, marginTop: 10, maxWidth: 380, lineHeight: 1.65 }}>
