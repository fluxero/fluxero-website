    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <h3 className="font-display font-black text-cream mb-2" style={{ fontSize: 'clamp(34px, 3vw, 42px)', lineHeight: 0.95 }}>
            BUILT.<br/>
            ...
            {milestones.map((m, i) => (
              <div key={i} className="flex items-center gap-4 rounded-lg px-4 py-3"
                ...
                <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0"
                  ...
                  {m.done && <span style={{ fontSize: 13, color: INK, fontWeight: 800 }}>✓</span>}
                </div>
