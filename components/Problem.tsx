          ...
          >
            ...
            <ResponsiveContainer width="100%" height={220}>
              <AreaChart data={dailyProfile}>
                ...
                <XAxis dataKey="t" stroke="none" tick={{ fill: '#64748B', fontSize: 10, fontFamily: 'JetBrains Mono' }} />
                <YAxis stroke="none" tick={{ fill: '#64748B', fontSize: 10, fontFamily: 'JetBrains Mono' }} unit="%" />
