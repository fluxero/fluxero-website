      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        >
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 14, marginBottom: 18 }}>
            ...
            <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: 15, letterSpacing: '0.25em', textTransform: 'uppercase', color: '#00D68F' }}>
              How it works
            </span>
            <div style={{ width: 28, height: 1, background: '#00D68F' }} />
          </div>
          <h2 style={{ fontFamily: '"DM Serif Display", serif', fontSize: 'clamp(32px, 4vw, 56px)', color: '#F0EBE0', lineHeight: 1.1, fontWeight: 400 }}>
            ...
            <React.Fragment key={c.label}>
              ...
              >
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: '"IBM Plex Mono", monospace', fontSize: 13, color: c.color, opacity: 0.7, letterSpacing: '0.12em' }}>
                    0{i + 1}
                  </span>
                </div>
