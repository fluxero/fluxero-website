  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', width: 128, height: 128 }}>
        ...
        >
          <span
            ...
            style={{ fontSize: 22, lineHeight: 1, color }}
          >
            {value}
          </span>
          <span className="font-mono" style={{ fontSize: 13, color: '#64748B', letterSpacing: '0.05em' }}>
            TWh/yr
          </span>
        </div>
      </div>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p className="font-mono" style={{ fontSize: 16, color: '#64748B', letterSpacing: '0.08em' }}>
          wasted annually
        </p>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <p
        ...
        style={{ fontSize: 17, color: '#00D68F', marginBottom: 16, letterSpacing: '0.2em' }}
      >
      ...
      <p className="font-mono" style={{ fontSize: 17, color: '#475569', marginTop: 16 }}>
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
        ...
        <span className="font-display font-bold" style={{ fontSize: 21, color: '#F1F5F9' }}>
          {country}
        </span>
      </div>
      <p
        className="font-display font-black"
        style={{ fontSize: 19, color: accent, marginBottom: 10, lineHeight: 1.3 }}
      >
        {stat}
      </p>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 56 }}>
          ...
          <span
            ...
            style={{ fontSize: 17, letterSpacing: '0.25em', color: '#00D68F' }}
          >
            Global Waste
          </span>
        </div>
